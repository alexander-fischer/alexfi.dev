...
-   **Tech stack:**
    ...
    -   Language model: [LFM2-8B-A1B](https://huggingface.co/LiquidAI/LFM2-8B-A1B)
    -   TTS: Piper
...
Next, the text instruction is processed by [LFM2-8B-A1B](https://huggingface.co/LiquidAI/LFM2-8B-A1B). This small yet capable model is responsible for recognizing which action or “tool” to invoke, whether that’s checking the weather, answering a Wikipedia query, or controlling your Philips Hue lights. LFM2-8B-A1B manages to perform nearly as well as much larger models, which makes it a practical choice for edge devices.
